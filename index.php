    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">Aan Bakery</a>
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="#menu" class="nav__link">Hots seller</a></li>
                        <li class="nav__item"><a href="#contact" class="nav__link">Contact us</a></li>
                        <li class="nav__item"><a href="login.php" class="nav__link">Account</a></li>
                        <li class="nav__item"><a href="cart.php"><i class='bx bx-cart'></i></a>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Bakery</h1>
                        <h2 class="home__subtitle">Try the best pastry of <br> the week.</h2>
                        <a href="Cart.html" class="button">View Menu</a>
                    </div>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <p class="about__description">We cook the best pastry in the entire city, with excellent customer service, the best meals and at the best price, visit us.</p>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">The best pastry</h3>
                        <p class="services__description">We offer our clients excellent quality services for many years, with the best and delicious food in the city.</p>
                    </div>
            ...
            <section class="menu section bd-container" id="menu">
                <span class="section-subtitle">HOT SELLER</span>
                <h2 class="section-title">Best seller this month</h2>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assets/img/plate1.1.png" alt="" class="menu__img">
                        <h3 class="menu__name">Brownie nutella</h3>
                        <span class="menu__detail">By Nurul Syuhada</span>
                        <span class="menu__preci">RM15.00</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/plate7.0.png" alt="" class="menu__img">
                        <h3 class="menu__name">Blueberry Ice-cream Cake</h3>
                        <span class="menu__detail">By Chef Aan</span>
                        <span class="menu__preci">RM67.00</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assets/img/plate7.1.png" alt="" class="menu__img">
                        <h3 class="menu__name">Chocolate Ripple Ice-cream Cake</h3>
                        <span class="menu__detail">By Chef Aan</span>
                        <span class="menu__preci">RM67</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/plate4.webp" alt="" class="menu__img">
                        <h3 class="menu__name">Crepe durian</h3>
                        <span class="menu__detail">By Kek Durian Viral</span>
                        <span class="menu__preci">RM12.50</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assets/img/plate7.2.png" alt="" class="menu__img">
                        <h3 class="menu__name">Chocolate Walnut Ice-cream Cake</h3>
                        <span class="menu__detail">By Chef Aan</span>
                        <span class="menu__preci">RM67</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    ...
                    <div class="menu__content">
                        <img src="assets/img/plate6.0.png" alt="" class="menu__img">
                        <h3 class="menu__name">Tiramisu</h3>
                        <span class="menu__detail">By Chef Aan</span>
                        <span class="menu__preci">RM7.50</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                </div>
            </section>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    ...
                    <img src="assets/img/movil-app2.0.png" alt="" class="app__img">
                </div>
            </section>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Aan Bakery</a>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>Jr Union #999</li>
                        <li>00 - 888 - 666</li>
                        <li>AanBakery@email.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; MARCH 2023. All right reserved</p>
        </footer>
